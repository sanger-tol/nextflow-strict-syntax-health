...
- **Last updated:** 2026-05-25 00:24:26 UTC
- **Nextflow version:** 26.04.2

## Pipelines

- **Strict syntax:** 0 parse errors, 6 errors, 209 warnings across 20 pipelines
...
- **Strict syntax:** 0 parse errors, 0 errors, 0 warnings across 33 modules
- **Topic + Version:** 33/33 (100.0%) modules have `topics:` and `versions:` in meta.yml
- **Zero errors:** 33 modules (100.0%)
...
<details>
<summary>Module Results (33 modules)</summary>
...
- **Strict syntax:** 0 parse errors, 0 errors, 1 warnings across 22 subworkflows
- **Versions channel:** 22/22 (100.0%) subworkflows do not emit a `versions` output channel
- **Zero errors:** 22 subworkflows (100.0%)
...
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :---------: | -----: | -------: | :----------------: | :---------------------------------------------------------------------------------------: |
| :white_check_mark: [busco_gene](https://github.com/sanger-tol/nf-core-modules/tree/main/subworkflows/sanger-tol/busco_gene)                                                             |     No      |      0 |        1 | :white_check_mark: |                [View](lint_results/subworkflow-results/busco_gene_lint.md)                |
