...
- **Last updated:** 2026-06-18 00:34:19 UTC
- **Nextflow version:** 26.04.3

## Pipelines

- **Strict syntax:** 0 parse errors, 7 errors, 231 warnings across 20 pipelines
...
- **Strict syntax:** 0 parse errors, 1 errors, 0 warnings across 22 subworkflows
- **Versions channel:** 22/22 (100.0%) subworkflows do not emit a `versions` output channel
- **Zero errors:** 21 subworkflows (95.5%)
...
<details>
<summary>Subworkflow Results (22 subworkflows)</summary>

| Subworkflow                                                                                                                                                              | Parse Error | Errors | Warnings |  versions channel  |                                        Lint Output                                        |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | :---------: | -----: | -------: | :----------------: | :---------------------------------------------------------------------------------------: |
| :x: [fasta_10x_polishing_longranger_freebayes](https://github.com/sanger-tol/nf-core-modules/tree/main/subworkflows/sanger-tol/fasta_10x_polishing_longranger_freebayes) |     No      |      1 |        0 | :white_check_mark: | [View](lint_results/subworkflow-results/fasta_10x_polishing_longranger_freebayes_lint.md) |
