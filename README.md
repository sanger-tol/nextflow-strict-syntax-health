...
- **Last updated:** 2026-04-24 00:20:29 UTC
- **Nextflow version:** 26.03.3-edge

## Pipelines

- **Strict syntax:** 0 parse errors, 6 errors, 167 warnings across 19 pipelines
...
| :x: [genomeassembly](https://github.com/sanger-tol/genomeassembly)               |     No      |      0 |        2 |     Yes     | :negative_squared_cross_mark: |    [View](lint_results/pipeline-results/genomeassembly_lint.md)     |    [View](lint_results/prints-help-results/genomeassembly_help.txt)     |
...
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :---------: | -----: | -------: | :----------------: | :---------------------------------------------------------------------------------------: |
| :white_check_mark: [fasta_purge_retained_haplotype](https://github.com/sanger-tol/nf-core-modules/tree/main/subworkflows/sanger-tol/fasta_purge_retained_haplotype)                     |     No      |      0 |        1 | :white_check_mark: |      [View](lint_results/subworkflow-results/fasta_purge_retained_haplotype_lint.md)      |
