...
- **Last updated:** 2026-08-17 00:04:45 UTC
- **Nextflow version:** 26.07.0-edge

## Pipelines

- **Strict syntax:** 0 parse errors, 2 errors, 160 warnings across 19 pipelines
- **Versions Mix:** 10/19 (52.6%) pipelines do not use the `ch_versions += +ch_versions.mix` anti-pattern
- **Zero issues:** 2 pipelines (10.5%)
...
| :x: [nfmicrofinder](https://github.com/sanger-tol/nfmicrofinder)                          |     No      |      0 |        0 |     No      | :negative_squared_cross_mark: |     [View](lint_results/pipeline-results/nfmicrofinder_lint.md)     |     [View](lint_results/prints-help-results/nfmicrofinder_help.txt)     |
